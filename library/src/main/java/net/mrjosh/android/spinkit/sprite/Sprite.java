package net.mrjosh.android.spinkit.sprite;
...
import net.mrjosh.android.spinkit.animation.AnimationUtils;
import net.mrjosh.android.spinkit.animation.FloatProperty;
import net.mrjosh.android.spinkit.animation.IntProperty;
